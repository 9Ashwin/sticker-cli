...
func defaultErrors() []schemaError {
	return []schemaError{
		...
		{Type: "conflict", Subtype: "collection_exists", ExitCode: 6},
...
func setupMetadata() commandMetadata {
	return commandMetadata{
		...
		Description: "Install the curated pack by default. Pass --pack all to explicitly select the full pack; setup is a convenience wrapper around the regular packs install contract.",
		Effect:      effectWrite,
		Flags: []flagMetadata{
...
func favoriteCollectionsCreateMetadata() commandMetadata {
	return commandMetadata{
		...
		Result:      objectSchema("collection", "object", "changed", "bool", "dry_run", "bool"),
		Errors:      defaultErrors(),
...
func favoriteCollectionsRemoveMetadata() commandMetadata {
	return commandMetadata{
		...
		Description: "Remove a custom collection and move its members into the default favorites collection.",
		Effect:      effectWrite,
		Parameters:  []parameterMetadata{{Name: "id", Type: "string", Source: "argument", Description: "Collection ID", Required: true}},
		Flags:       []flagMetadata{{Name: "dry-run", Type: "bool", Default: false, Description: "Show the change without writing"}},
		Result:      objectSchema("removed", "bool", "moved", "int", "dry_run", "bool"),
		Errors:      defaultErrors(),
